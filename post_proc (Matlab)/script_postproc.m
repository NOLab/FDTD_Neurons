...
basefolder='F:\_NEURONS\_test neurons anisotropy\';
name00='NAMOD813';
name90='NAMOD814';

cd(basefolder);
[pangle,res00]=plot_interface_functionxyz([basefolder,name00],'_neuron_polar00_radius_',1)
res000=nonzeros(res00);
cd ..
saveas(gcf,[name00,'.png'])

cd(basefolder);
[pangle,res90]=plot_interface_functionxyz([basefolder,name90],'_neuron_polar90_radius_',2)
...
figure(4);
plot(position,res00,'b',position,res90,'g','LineWidth',2.0);
